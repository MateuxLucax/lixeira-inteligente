      ...
      <div class="container altura-80vh">
        <div class="row altura-80vh">
          <div class="col s12 m8 l7 altura-80vh landing-container faca-voce-tambem-container ">
            ...
            <p class="texto paleta-text text-branco">Além da Arduino IDE, você irá precisar dos arquivos que estão disponibilizados <a class="link-branco" href="">neste link</a>. Pois iremos utilizar eles durante o processo de montagem da lixeira.</p>
          </div>
          <div class="col s12 m4 l5 altura-80vh landing-container justify-right-grid">
            <img class="o-que-e-img fadeIn"  src="../assets/img/faca-voce-mesmo/arduino-logo.svg" alt="Arduino">
          </div>
        </div>
      </div>
    </div>

    <div class="iniciar-passo-a-passo altura-60vh">
      <div class="row altura-60vh">
        <div class="container altura-60vh">
          <div class="col s12 m6 altura-60vh contador-container ">
            <h2 class="titulo paleta-text">Agora que tudo está pronto, vamos lá!</h2>
            <p class="texto">Se você já adquiriu os materiais necessários, instalou os softwares e baixou os arquivos necessários, chegou a hora de iniciar a construção da sua Lixeira Inteligente, e paraa isso, buscamos desenvolver um passo a passo intuitivo para que mesmo aqueles que não possuem habilidades com programação, elétrica e eletrônica, possam construir a sua lixeira, e auxiliar um pouco nosso querido planeta.</p>
          </div>
          <div class="col s12 m6 altura-60vh iniciar-passo-a-passo-container">
            <a class="waves-effect waves-light btn-large btn-primary" href="1/"><i class="material-icons left">code</i>Iniciar passo a passo</a>
          </div>
        </div>
      </div>  
    </div>
